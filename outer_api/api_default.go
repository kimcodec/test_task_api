...
func (r ApiInfoGetRequest) RegNum(regNum string) ApiInfoGetRequest {
	r.regNum = &regNum
	return r
}

func (r ApiInfoGetRequest) Execute() (*Car, *http.Response, error) {
...
//  @return Car
func (a *DefaultApiService) InfoGetExecute(r ApiInfoGetRequest) (*Car, *http.Response, error) {
	var (
	...
	if r.regNum == nil {
		return localVarReturnValue, nil, reportError("regNum is required and must be specified")
	}

	localVarQueryParams.Add("regNum", parameterToString(*r.regNum, ""))
